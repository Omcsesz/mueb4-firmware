...
void MX_TIM14_Init(void)
{
  ...
  htim14.Init.Period = ART_NET_SYNC_LOST;
...
void MX_TIM16_Init(void)
{
  ...
  htim16.Init.Period = E131_NETWORK_DATA_LOSS_TIMEOUT;
...
void MX_TIM17_Init(void)
{
  ...
  htim17.Init.Period = E131_NETWORK_DATA_LOSS_TIMEOUT;
